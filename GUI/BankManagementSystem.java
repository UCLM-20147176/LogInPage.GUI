    ...
    private static void createAndShowGUI() {
        ...
        JPanel gradientBackgroundPanel = new JPanel(new BorderLayout()) {
            ...
            protected void paintComponent(Graphics g) {
                ...
                Color color1 = new Color(2, 0, 36);
                Color color2 = new Color(94, 94, 144);
                Color color3 = new Color(0, 212, 255);
        ...
        mainFrame.setContentPane(gradientBackgroundPanel);
        ...
        gradientBackgroundPanel.add(containerPanel);
